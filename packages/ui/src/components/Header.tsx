...
const NotificationButton: React.FC<{
  ...
  return (
    <Popover
      ...
      content={
        <Card design={{ width: "400px", maxWidth: "90vw", maxHeight: "500px", overflow: "auto", padding: 0 }}>
          {/* Header */}
          <Flex
            design={{
              padding: 3,
              ...
              {items.slice(0, 10).map((notification) => (
                ...
                >
                  <Flex gap={2 as any} design={{ flex: 1, alignItems: "flex-start" }}>
                    ...
                    <Flex design={{ flexDirection: "column", gap: 0.5, flex: 1 }}>
                      <Text
                        design={{
                      ...
                      <Text design={{ fontSize: "0.7rem", color: "color.text.tertiary" }}>
...
const MobileSearch: React.FC<{
  ...
  return (
    <Popover
      ...
      content={
        <Card design={{ padding: 2, minWidth: "320px", maxWidth: "90vw" }}>
  ...
  return (
    ...
    >
      ...
      <Popover
        ...
        placement="bottom-start"
        content={
          <Card design={{ padding: 1, minWidth: "180px" }}>
      ...
      <Box design={{ flex: 1, position: "relative" }}>
        ...
        {showResults && onSearchResults && (
          ...
          >
            <Card design={{ width: "100%", maxHeight: "400px", overflow: "auto", padding: 0, shadow: "shadow.lg" }}>
              {isLoading ? (
                ...
                <Flex design={{ padding: 4, justifyContent: "center", flexDirection: "column", alignItems: "center", gap: 2 }}>
                  ...
                  <Text design={{ color: "color.text.tertiary", fontSize: "0.75rem" }}>Попробуйте изменить запрос</Text>
                </Flex>
              ) : (
                <Flex design={{ flexDirection: "column" }}>
                  {(() => {
                      ...
                      <React.Fragment key={type}>
                        {Object.keys(grouped).length > 1 && (
                          ...
                          >
                            ...
                            <Box design={{ flex: 1 }} />
                            <Text design={{ fontSize: "0.75rem", color: "color.text.tertiary" }}>
                              {items.length}
                            </Text>
                          </Flex>
                        )}
...
const UserProfile: React.FC<{
  ...
  onSettingsClick?: () => void;
  onLogoutClick?: () => void;
}> = ({ user, isMobile, onProfileClick, onSettingsClick, onLogoutClick }) => {
  if (!user) return null;
...
// Дефолтные опции поиска (без иконок, они будут добавлены в использовании)
...
export const Header: React.FC<HeaderProps> = ({
  ...
  const showSearch = onSearch || searchModel;
