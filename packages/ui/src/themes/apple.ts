export const apple = {
  color: {
    ...
    bg: {
      primary: "rgba(255, 255, 255, 0.7)", // Semi-transparent white for glass effect
      secondary: "rgba(242, 242, 247, 0.8)", // Light gray glass
      tertiary: "rgba(229, 229, 234, 0.6)", // Lighter gray glass
    },
  },
  radius: {
    sm: "10px",
...
export type AppleTheme = typeof apple;
