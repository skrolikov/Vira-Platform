...
import { Table, type TableProps, type TableColumn } from "@vira-ui/ui";
import { Input } from "@vira-ui/ui";
import { Checkbox } from "@vira-ui/ui";

/**
 * ViraDataGrid - Enterprise Data Grid с inline editing, drag & drop колонок
 */
...
export interface ViraDataGridProps<T = any> extends Omit<TableProps<T>, "columns" | "design">, Omit<ViraComponentProps, "design"> {
...
export const ViraDataGrid = <T extends Record<string, any>>({
