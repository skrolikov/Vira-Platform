...
/**
 * ViraVirtualList - Виртуализированный список для больших данных
 * Рендерит только видимые элементы для оптимизации производительности
 */

export interface ViraVirtualListProps<T = any> extends ViraComponentProps {
  items: T[];
...
export function ViraVirtualList<T = any>({
  items,
  itemHeight,
  containerHeight,
  renderItem,
